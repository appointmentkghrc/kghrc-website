        ...
        <div className="rounded-3xl border border-slate-200 bg-emerald-50 px-6 py-7 shadow-sm md:px-10 md:py-8">
          <div className="flex flex-col gap-7 md:flex-row md:items-center md:justify-between">
            <div className="flex items-stretch gap-5 md:gap-7">
              <div className="h-20 w-20 shrink-0 self-center sm:h-32 sm:w-32 md:h-32 md:w-32 lg:h-32 lg:w-32 xl:h-32 xl:w-32">
                <img
              ...
              <div className="flex min-w-0 flex-1 flex-col justify-center gap-3 text-left md:gap-4">
                <p className="text-sm font-semibold leading-snug text-emerald-950 md:text-lg">
                  Patients treated under Ayushman Bharat Yojana
                </p>
                <p className="text-left text-3xl font-extrabold leading-none tracking-tight text-slate-900 md:text-5xl">
                  {value}
                </p>
              </div>
            </div>
