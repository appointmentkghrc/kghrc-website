...
export default function PmjayPatientsTreatedSection({
  ...
  return (
    <section className="bg-white py-12">
      <div className="max-w-[1400px] mx-auto bg-emerald-50px-6 lg:px-12">
        <div className="rounded-3xl border bg-emerald-50  border-slate-200  px-6 py-7 md:px-10 md:py-8 shadow-sm">
          <div className="flex flex-col md:flex-row  md:items-center md:justify-between gap-7">
            <div className="flex items-stretch gap-5 md:gap-7">
              ...
              <div className="flex min-w-0 flex-1 flex-col justify-center gap-3 md:gap-4">
                <p className="rounded-xl  px-4 py-3 text-base font-semibold text-emerald-950 md:text-lg md:px-5 md:py-3.5">
